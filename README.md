...
> Auto print data as formatted ascii tables

[![PyPI version](https://badge.fury.io/py/auto-table-print.svg)](https://pypi.org/project/auto-table-print/)
...
```bash
pip install auto-table-print
```

## Quick Start

```python
from auto_table_print import print
...
from auto_table_print import batch
